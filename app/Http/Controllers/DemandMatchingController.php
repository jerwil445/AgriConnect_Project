...
class DemandMatchingController extends Controller
{
    ...
    public function listTransactions(Request $request)
    {
        ...
        // Prepare messages for pre-rendering if a transaction is selected
        $messages = collect();
        if ($selectedTransaction) {
            // Ensure necessary relations are loaded for the details/sidebar
            $selectedTransaction->load(['product', 'buyer', 'farmer', 'conversationThread', 'demand']);
