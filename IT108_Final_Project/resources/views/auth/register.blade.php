<div id="registerModal"
    class="modal fixed inset-0 backdrop-blur-sm bg-black bg-opacity-50 flex items-center justify-center z-50 opacity-0 scale-95 pointer-events-none transition-all duration-300">
    ...
    <di v
        ...
        <!-- FARMER FORM -->
        <form action="#" method="POST" id="farmerForm" class="space-y-4 mt-5 pb-6 transition-opacity duration-300">
            @csrf
            <div class= "flex flex-col space-y-4 bg-green-100 border-green-400 p-4 rounded-sm">
        ...
        <p class="text-center text-sm text-gray-600 mt-2">
            ...
            <button id="loginBtn" type="button" class="text-green-600 font-semibold hover:underline">
                Login here
            </button>
        </p>
    </di>
