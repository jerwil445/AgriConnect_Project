...
@section('content')
    <div class="px-4 py-6 lg:py-8 ml-64">
        <div class="bg-white rounded-lg shadow-md p-4 lg:p-6 overflow-visible">
            <h1 class="text-xl lg:text-2xl font-bold text-gray-800 mb-4 lg:mb-6">Order Management</h1>

            <form method="GET" class="mb-4 lg:mb-6 grid gap-3 lg:grid-cols-3 items-end">
                <div class="flex items-center gap-2">
                    ...
                    <span class="text-sm text-gray-600 hidden sm:inline">entries</span>
                </div>
                            ...
                            @foreach ($orders as $order)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        {{ $order->buyer->first_name }} {{ $order->buyer->last_name }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
