                    ...
                    <div class="space-y-4 lg:space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="variety_size" id="variety_size"
                                value="{{ old('variety_size', $product->variety_size) }}"
                                class="w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500">
                            @error('variety_size')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
        ...
        function renderImagePreviews() {
            ...
            selectedImageFiles.forEach((file, index) => {
                ...
                removeButton.className =
                    'absolute right-2 top-2 flex h-8 w-8 items-center justify-center rounded-full bg-white/95 text-base font-bold text-red-600 shadow-md transition hover:bg-red-600 hover:text-white';
                ...
                if (index === 0) {
                    ...
                    coverBadge.className =
                        'absolute bottom-2 left-2 rounded-full bg-green-600 px-3 py-1 text-xs font-semibold text-white shadow';
