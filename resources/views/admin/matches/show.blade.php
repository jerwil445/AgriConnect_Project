                    ...
                    <div class="bg-gray-50 p-6 rounded-lg">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <p class="mt-1 text-sm text-gray-900">{{ $match->product->product_name ?: $match->product->egg_type ?: 'N/A' }}</p>
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-600">Variety/Size</label>
                                <p class="mt-1 text-sm text-gray-900">{{ $match->product->variety_size ?: 'N/A' }}</p>
                            </div>
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-sm text-gray-900">PHP {{ number_format((float) $match->product->price, 2) }}/{{ $match->product->unit }}</p>
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-600">Total Amount</label>
                                <p class="mt-1 text-sm text-gray-900">PHP {{ number_format((float) ($match->product->total_amount ?? 0), 2) }}</p>
                            </div>
                ...
                <div class="mt-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        ...
                        <div class="bg-gray-50 p-3 rounded">
                            ...
                            <p class="text-sm text-gray-900">PHP {{ number_format((float) ($match->demand->target_price ?? 0), 2) }}</p>
                        </div>
