...
<div id="loginModal"
    class="modal fixed text-center inset-0 bg-black bg-gray-100  flex items-center justify-center   transition-all duration-300">
    <div class="bg-white  rounded-md w-1/3 p-6 relative shadow-lg transform transition-transform duration-300 flex">
