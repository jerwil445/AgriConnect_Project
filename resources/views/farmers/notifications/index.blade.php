...
@section('content')
    <div class="ml-64">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 mb-4 sm:mb-6">
            ...
            <a href="{{ route('farmer.matches') }}" class="text-indigo-600 hover:text-indigo-800 text-sm">
        ...
        @if ($notifications->isEmpty())
            <div class="bg-white shadow-md rounded-lg p-4 sm:p-6 text-center">
                ...
                <p class="mt-3 sm:mt-4 text-gray-600 font-medium">No notifications yet.</p>
                <p class="text-gray-500 text-sm mt-2">You'll see notifications here when buyers show interest in your
                    products.</p>
            </div>
        @else
