                            ...
                            <div class="grid grid-cols-2 gap-3">
                                <div>
                                    ...
                                    <input type="number" name="quantity" id="modal_quantity"
                                        ...
                                        class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-green-400 focus:border-transparent transition-all"
                                        required>
                                    <p id="modal_quantity_error" class="mt-1 text-xs text-red-500 font-medium hidden">Quantity cannot be negative.</p>
                                    @error('quantity')
                                        <p class="mt-1 text-xs text-red-500 font-medium">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                <div>
                                    ...
                                    <input type="number" name="quantity" id="edit_quantity"
                                        class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-amber-400 focus:border-transparent transition-all"
                                        required>
                                    <p id="edit_quantity_error" class="mt-1 text-xs text-red-500 font-medium hidden">Quantity cannot be negative.</p>
                                </div>
                                <div>
                                    <label for="edit_unit"
                                        class="block text-sm font-bold text-gray-700 mb-1.5">Unit</label>
