...
<div class="ml-64">
    <form action="{{ route('products.update', $product) }}" method="POST" enctype="multipart/form-data" id="product-form">
        ...
        <input type="hidden" name="egg_type" id="egg_type_hidden" value="{{ old('egg_type', $product->egg_type) }}">
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                @php
                                    $currentEggType = old('egg_type', $product->egg_type);
                                    $isChickenColor = in_array($currentEggType, ['brown', 'white']);
                                @endphp
                                <select id="egg_type_select" required
                                    ...
                                    <option value="chicken" {{ $currentEggType == 'chicken' || $isChickenColor ? 'selected' : '' }}>🐔 Chicken Eggs</option>
                                    <option value="duck" {{ $currentEggType == 'duck' ? 'selected' : '' }}>🦆 Duck Eggs</option>
                                    <option value="quail" {{ $currentEggType == 'quail' ? 'selected' : '' }}>🐦 Quail Eggs</option>
                                    <option value="native_chicken" {{ $currentEggType == 'native_chicken' ? 'selected' : '' }}>🐓 Native Chicken Eggs</option>
                                </select>
                                <div id="chicken-color-wrapper" class="mt-3 {{ $isChickenColor ? '' : 'hidden' }}">
                                    ...
                                    <select id="chicken_color" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500 text-gray-900">
                                        ...
                                        <option value="brown" {{ $currentEggType == 'brown' ? 'selected' : '' }}>Brown Eggs</option>
                                        <option value="white" {{ $currentEggType == 'white' ? 'selected' : '' }}>White Eggs</option>
                                    </select>
                                </div>
                                @error('egg_type')
                                    ...
                                    <div class="flex-1 grid grid-cols-1 sm:grid-cols-3 gap-4">
                                        <div>
                                            ...
                                            <select name="sizes[{{ $index }}][name]" required
                                                ...
                                                <option value="extra_large" {{ $size->size_name == 'extra_large' || $size->size_name == 'jumbo' ? 'selected' : '' }}>Extra Large</option>
                                            </select>
                                        </div>
                                        <div>
