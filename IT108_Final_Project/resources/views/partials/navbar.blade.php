<header class="fixed w-full z-50 bg-white shadow-md ">
    <nav class="container mx-auto flex justify-between items-center p-3">
        ...
        <ul class="flex space-x-6 items-center">
            <li><a href="#home" class="hover:text-green-600 font-medium">Home</a></li>
            ...
            @else
                <div class="space-x-4">
                    <button onclick="openModal('loginModal')"
                        class="bg-white text-green-600 px-4 py-1 border border-green-600 rounded hover:bg-green-600 hover:text-white transition-all duration-500">Login</button>
                    <button onclick="openModal('registerModal')"
                        class="bg-green-600 text-white px-4 py-1  border rounded hover:bg-white hover:text-green-600 hover:border-green-600 transition-all duration-500">Register</button>
                </div>
            @endauth
        </ul>
    </nav>
