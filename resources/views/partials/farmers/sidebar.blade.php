@php
    ...
    $navItems = [
        ...
        ['label' => 'Listings Products', 'icon' => 'M15 4h3a1 1 0 0 1 1 1v15a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1V5a1 1 0 0 1 1-1h3m0 3h6m-3 5h3m-6 0h.01M12 16h3m-6 0h.01M10 3v4h4V3h-4Z', 'route' => route('farmer.products.index'), 'active' => request()->routeIs('farmer.products.*')],
        ...
        ['label' => 'Analytics', 'icon' => 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6', 'route' => route('farmer.analytics'), 'active' => request()->routeIs('farmer.analytics')],
    ];
@endphp

<aside id="sidebar"
    class="fixed top-0 left-0 h-screen w-64 bg-white shadow-lg z-40 flex flex-col transform -translate-x-full md:translate-x-0 transition-transform duration-300 ease-in-out farmer-sidebar">
