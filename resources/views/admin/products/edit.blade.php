...
@section('content')
    <div
        class="ml-72 mr-5 mt-20 relative bg-gradient-to-br from-emerald-50/50 via-white to-green-50/50 rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-white overflow-hidden">
            ...
            <div class="max-w-6xl mx-auto">
                ...
                <div class="flex justify-between items-center mb-8 pb-4 border-b border-green-100">
                    <div class="flex items-center gap-3">
                        <div
                            class="w-10 h-10 bg-green-100 rounded-xl flex items-center justify-center text-green-600 shadow-inner">
                            <i class="fas fa-box-open"></i>
                        </div>
                        <div>
                            <h2 class="text-2xl font-black text-gray-800 tracking-tight">Edit Product</h2>
                            <p class="text-sm text-gray-500 font-medium mt-0.5">Update product listing details and imagery
                            </p>
                        </div>
                    </div>
                    ...
                    <a href="{{ route('admin.products.index') }}"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg"
                            class="h-4 w-4 mr-1.5 text-gray-400 group-hover:text-gray-600 transition-colors"
                ...
                @if ($errors->any())
                    <div
                        class="bg-red-50/80 backdrop-blur-sm border-l-4 border-red-500 text-red-800 px-5 py-4 rounded-r-xl shadow-sm mb-8">
                ...
                <form action="{{ route('admin.products.update', $product) }}" method="POST" enctype="multipart/form-data"
                    class="bg-white/60 backdrop-blur-xl rounded-2xl border border-white shadow-sm p-6 lg:p-8">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
                        ...
                        <div class="space-y-8">
                            ...
                            <div>
                                <h3
                                    class="text-sm font-bold uppercase tracking-wider text-green-700 mb-6 pb-2 border-b border-gray-100">
                                    Primary Details</h3>
                                <div class="space-y-6">
                                    <div class="relative w-full group">
                                        ...
                                        <label for="category"
                                            class="absolute left-4 -top-2.5 text-xs font-medium bg-white px-1 text-gray-500 transition-all rounded">
                                    ...
                                    <div id="other_product_container" class="hidden pt-2">
                                        <div class="relative w-full">
                                            <input type="text" name="other_product_name" id="other_product_name"
                                                value="{{ old('other_product_name', $product->product_name) }}" placeholder=" "
                                            ...
                                            <label for="other_product_name"
                                                class="absolute left-4 -top-2.5 text-xs font-medium bg-white px-1 text-gray-500 transition-all peer-placeholder-shown:top-3.5 peer-placeholder-shown:text-base peer-focus:-top-2.5 peer-focus:text-xs peer-focus:text-green-600 rounded cursor-text">
                                                Product Name (Custom)
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="relative w-full pt-2">
                                        <input type="text" name="variety_size" id="variety_size"
                                            value="{{ old('variety_size', $product->variety_size) }}" placeholder=" "
                                            class="peer w-full px-4 py-3 border border-gray-200 rounded-xl bg-white/50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-green-400 focus:border-transparent transition-all placeholder-transparent shadow-sm">
                            ...
                            <div>
                                <h3
                                    ...
                                    Media Gallery</h3>
                                <div
                                    class="rounded-2xl border border-gray-200 bg-gradient-to-br from-green-50 via-white to-emerald-50 p-4 shadow-sm">
                                    <div id="image-upload-dropzone"
                                        ...
                                        <label for="images" class="block cursor-pointer">
                                            <div class="mx-auto flex flex-col items-center text-center">
                                                <div
                                                    class="flex h-14 w-14 items-center justify-center rounded-2xl bg-green-100 text-green-600 shadow-sm mb-3">
                                                    <i class="fas fa-cloud-upload-alt text-2xl"></i>
                                                </div>
                                                <h3 class="text-sm font-semibold text-gray-900">Drop replacement images here
                                                </h3>
                                                <p class="mt-1 text-xs text-gray-500">or click to browse from device</p>
                                                <div
                                                    class="mt-4 flex flex-wrap items-center justify-center gap-2 text-[10px] text-gray-500">
                                                    <span
                                                        class="rounded-full bg-white px-2.5 py-1 shadow-sm border border-gray-100">Replaces
                                                        current</span>
                                                    <span
                                                        class="rounded-full bg-white px-2.5 py-1 shadow-sm border border-gray-100">Max
                                                        10 images</span>
                                                </div>
                                            </div>
                                        </label>
                                    ...
                                    <div id="image-selection-meta"
                                        class="mt-4 hidden items-center justify-between rounded-xl border border-gray-200 bg-white px-4 py-3 shadow-sm">
                                        <div>
                                            <p id="selected-image-count" class="text-sm font-semibold text-gray-900">0
                                                images selected</p>
                                            <p id="image-limit-note" class="text-[10px] text-gray-500">Uploading new images
                                                replaces current gallery.</p>
                                        </div>
                                        <button type="button" id="clear-selected-images"
                                            class="inline-flex flex-shrink-0 items-center rounded-lg border border-gray-200 bg-gray-50 px-3 py-1.5 text-xs font-medium text-gray-600 transition hover:bg-gray-100 hover:text-red-500">
                                            Clear All
                                        </button>
                                    </div>
                                </div>
                                ...
                                @if($product->images->count() > 0)
                                    <div class="mt-5">
                                        <div class="flex items-center justify-between mb-3">
                                            ...
                                            <span
                                                class="rounded-full bg-green-100 text-green-700 px-2 py-0.5 text-[10px] font-bold border border-green-200">
                                        ...
                                        <div class="grid grid-cols-2 lg:grid-cols-3 gap-3">
                                            @foreach($product->images as $image)
                                                <div
                                                    class="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm group">
                                                    <div class="relative h-24 overflow-hidden bg-gray-100">
                                                        <img src="{{ asset('storage/' . $image->image_path) }}"
                                                            class="h-full w-full object-cover transition duration-300 group-hover:scale-110">
                                                        @if($loop->first)
                                                            <span
                                                                class="absolute bottom-1.5 left-1.5 rounded-full bg-gray-900/80 backdrop-blur-md px-2 py-0.5 text-[9px] font-bold text-white shadow-sm border border-gray-600/50">Cover</span>
                                                        @endif
                                                    </div>
                                                </div>
                                            @endforeach
                        ...
                        <div class="space-y-8">
                            ...
                            <div
                                class="bg-gradient-to-br from-green-50/50 to-emerald-50/50 p-6 rounded-2xl border border-green-100 shadow-sm relative overflow-hidden">
                                <div
                                    class="absolute -right-4 -top-4 text-green-200/40 transform rotate-12 pointer-events-none">
                                    <i class="fas fa-tags text-8xl"></i>
                                </div>
                                <h3
                                    class="text-sm font-bold uppercase tracking-wider text-green-800 mb-6 pb-2 border-b border-green-200/50 relative z-10">
                                    Pricing & Inventory</h3>

                                <div class="space-y-6 relative z-10">
                                    <div class="grid grid-cols-2 gap-4">
                                        <div class="relative w-full">
                                            <input type="number" name="quantity" id="quantity"
                                                value="{{ old('quantity', $product->quantity) }}" min="1" placeholder=" "
                                                required
                                            ...
                                            <label for="quantity"
                                                class="absolute left-4 -top-2.5 text-xs font-medium bg-emerald-50 px-1 text-gray-600 transition-all peer-placeholder-shown:top-3.5 peer-placeholder-shown:text-base peer-focus:-top-2.5 peer-focus:text-xs peer-focus:text-green-700 peer-focus:bg-white rounded cursor-text">
                                                Quantity
                                            </label>
                                        </div>
                                        ...
                                        <div class="relative w-full group">
                                            ...
                                            <label for="unit"
                                                class="absolute left-4 -top-2.5 text-xs font-medium bg-emerald-50 px-1 text-gray-600 rounded transition-all">
                                                Unit Type
                                            </label>
                                            <div
                                                class="absolute inset-y-0 right-4 flex items-center pointer-events-none text-gray-400">
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        <div class="relative w-full">
                                            ...
                                            <label for="price"
                                                class="absolute left-8 -top-2.5 text-xs font-medium bg-emerald-50 px-1 text-gray-600 transition-all peer-placeholder-shown:top-3.5 peer-placeholder-shown:text-base peer-focus:-top-2.5 peer-focus:text-xs peer-focus:text-green-700 peer-focus:bg-white peer-focus:left-4 rounded cursor-text">
                                                Price per Unit
                                            </label>
                                        </div>
                                        ...
                                        <div class="relative w-full">
                                            <div
                                                class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-green-600 font-bold">
                                                ₱
                                            </div>
                                            ...
                                            <label
                                                class="absolute left-4 -top-2.5 text-xs font-bold bg-emerald-50 px-1 text-green-700 rounded">
                                                Total Value
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="space-y-6">
                                    ...
                                    <div class="p-5 bg-gray-50/50 rounded-2xl border border-gray-100">
                                        <h4 class="text-xs font-bold text-gray-600 uppercase mb-4 flex items-center gap-2">
                                            <i class="fas fa-map-marker-alt"></i> Location Data</h4>
                                        <div class="grid grid-cols-2 gap-4">
                                            <div class="relative w-full">
                                                ...
                                                <label for="purok_street"
                                                    class="absolute left-3 -top-2 text-[10px] font-medium bg-white px-1 text-gray-500 transition-all peer-placeholder-shown:top-2 peer-placeholder-shown:text-sm peer-focus:-top-2 peer-focus:text-[10px] peer-focus:text-green-600 rounded cursor-text">
                                                    Street / Purok
                                                </label>
                                            </div>
                                            <div class="relative w-full">
                                                <input type="text" name="barangay" id="barangay"
                                                    value="{{ old('barangay', $product->barangay) }}" placeholder=" "
                                                    class="peer w-full px-3 py-2 border border-gray-200 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-green-400 focus:border-transparent transition-all placeholder-transparent text-sm">
                                                <label for="barangay"
                                                    class="absolute left-3 -top-2 text-[10px] font-medium bg-white px-1 text-gray-500 transition-all peer-placeholder-shown:top-2 peer-placeholder-shown:text-sm peer-focus:-top-2 peer-focus:text-[10px] peer-focus:text-green-600 rounded cursor-text">
                                                    Barangay
                                            ...
                                            <div class="relative w-full">
                                                <input type="text" name="province" id="province"
                                                    value="{{ old('province', $product->province) }}" placeholder=" "
                                                    class="peer w-full px-3 py-2 border border-gray-200 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-green-400 focus:border-transparent transition-all placeholder-transparent text-sm">
                                                <label for="province"
                                                    class="absolute left-3 -top-2 text-[10px] font-medium bg-white px-1 text-gray-500 transition-all peer-placeholder-shown:top-2 peer-placeholder-shown:text-sm peer-focus:-top-2 peer-focus:text-[10px] peer-focus:text-green-600 rounded cursor-text">
                                                    Province
    ...
    @vite('resources/js/admin/products/admin-products-edit.js')
@endsection