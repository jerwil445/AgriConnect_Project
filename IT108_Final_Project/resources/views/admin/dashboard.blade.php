                ...
                <div class="bg-white rounded-lg shadow p-6">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-2xl font-semibold text-gray-800">$24,568</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-4">
                    <div class="flex items-start space-x-4">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-gray-500">You created a new project "Website Redesign"</p>
                    ...
                    <div class="flex items-start space-x-4">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-gray-500">You completed "Create wireframes"</p>
                    ...
                    <div class="flex items-start space-x-4">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-gray-500">Sarah Johnson joined the Marketing team</p>
