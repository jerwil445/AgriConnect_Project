        ...
        <div class="max-w-7xl mx-auto">
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex justify-between items-center mb-6">
                    <h2 class="text-2xl font-bold text-gray-800">Audit Matches for "{{ $demand->product_name ?: $demand->egg_type }}"</h2>
                ...
                <div class="mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mt-2">
                        ...
                        <div class="bg-gray-50 p-3 rounded">
                            ...
                            <p class="text-sm text-gray-900">PHP {{ number_format((float) ($demand->target_price ?? 0), 2) }}</p>
                        </div>
                        <div class="bg-gray-50 p-3 rounded">
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">PHP {{ number_format((float) $match->product->price, 2) }}/{{ $match->product->unit }}</td>
