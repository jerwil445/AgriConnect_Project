                                    ...
                                    <div class="flex flex-wrap gap-3">
                                        @foreach($product->images as $image)
                                            <div class="relative group">
                                                <img src="{{ asset('storage/' . $image->image_path) }}" alt="{{ $product->egg_type }}" class="h-24 w-24 object-cover rounded-md border border-gray-200">
                                                @if($image->is_primary)
                            ...
                            @elseif($product->image)
                                <div class="mb-4">
                                    ...
                                    <div class="flex items-center gap-3">
                                        <img src="{{ asset('storage/' . $product->image) }}" alt="{{ $product->egg_type }}" class="h-24 w-24 object-cover rounded-md border border-gray-200">
                                    </div>
                                </div>
                            @endif
