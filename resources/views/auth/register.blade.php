...
@section('content')
    <div id="registerModal"
        ...
        <div class="bg-white flex mt-16 items-center shadow-lg rounded-md p-5 space-x-6 md:w-2/4 relative">
                            ...
                            <div class="farmer-info-container flex flex-col space-y-4 bg-white pb-2 border-green-400 absolute top-0 z-10 rounded-sm w-full {{ $activeRole === 'buyer' ? 'hidden' : '' }}"
                                ...
                                <div class="relative w-full">
                                    ...
                                    <input type="number" name="farm_size" id="farm-size" step="0.01" min="0"
                                        data-role-field="farmer" @if ($activeRole === 'buyer') disabled @endif
                                        class="peer w-full px-2 py-1.5 border border-gray-300 rounded-md focus:outline-none focus:border-green-500 focus:ring-1 focus:ring-green-500"
                                ...
                                <div class="relative w-full">
                                    ...
                                    <input type="number" name="experience_years" id="year-experience" min="0"
                                        max="100" step="1" data-role-field="farmer"
                                        @if ($activeRole === 'buyer') disabled @endif
                                        class="peer w-full px-2 py-1.5 border border-gray-300 rounded-md focus:outline-none focus:border-green-500 focus:ring-1 focus:ring-green-500"
                            ...
                            <div class="buyer-info-container flex flex-col space-y-4 bg-white w-full rounded-sm {{ $activeRole === 'buyer' ? '' : 'hidden' }}"
                                ...
                                <div class="relative w-full">
                                    ...
                                    <select name="business_type" id="business_type" data-role-field="buyer"
                                        ...
                                        <option value="wholesaler"
                                            {{ old('business_type') == 'wholesaler' ? 'selected' : '' }}>Wholesaler
                                        </option>
                                        <option value="retailer"
                                            {{ old('business_type') == 'retailer' ? 'selected' : '' }}>Retailer</option>
                                        <option value="exporter"
                                            {{ old('business_type') == 'exporter' ? 'selected' : '' }}>Exporter</option>
                                        <option value="processor"
                                            {{ old('business_type') == 'processor' ? 'selected' : '' }}>Processor</option>
                                        <option value="restaurant"
                                            {{ old('business_type') == 'restaurant' ? 'selected' : '' }}>Restaurant
                                        </option>
                                ...
                                <div class="relative w-full">
                                    ...
                                    <input type="text" id="preferred_products" name="preferred_products"
                                        data-role-field="buyer" @if ($activeRole !== 'buyer') disabled @endif
                                        class="peer w-full px-2 py-1.5 border border-gray-300 rounded-md focus:outline-none focus:border-green-500 focus:ring-1 focus:ring-green-500"
